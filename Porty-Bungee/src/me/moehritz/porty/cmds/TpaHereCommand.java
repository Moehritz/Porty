...
public class TpaHereCommand extends BasePortyCommand {
    ...
    public void executeCommand(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            ...
            sendMessages(targetPlayer, TextUtil.applyTag("<player>", fromPlayer.getName(), Messages.getMessage("tpahere", "&7The player &e<player> &7asks you to teleport to him. Use &e/tpaccept&7 or &e/tpdeny&7 in order to respond to it.")));
